...
class ImportConfiguration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $rootNode
            ...
            ->end()
            ->children()
            ->booleanNode('unit_work')
            ->defaultFalse()
            ->info('If false (default), all files are archived on critical error. If true, only invalid files are archived.')
            ->end()
            ->end()
            ->addDefaultsIfNotSet()
            ->end()
            ...
            ->booleanNode('unit_work')
            ->defaultFalse()
            ->info('If false (default), all files are quarantined on critical error. If true, only invalid files are quarantined.')
            ->end()
            ->end()
            ->addDefaultsIfNotSet()
            ->end()
